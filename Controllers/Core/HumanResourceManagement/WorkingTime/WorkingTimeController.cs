...
namespace Workforce.Server.Controllers.Core.HumanResourceManagement.WorkingTime
{
    ...
    public class WorkingTimeController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<Domain.Core.WorkManagement.WorkingTime.Entity.WorkingTime>> GetById(int id)
        {
            try
            {
        ...
        public async Task<ActionResult<Domain.Core.WorkManagement.WorkingTime.Entity.WorkingTime>> GetByEnvironmentIdAndId(int environmentId, int id)
        {
            try
            {
                var workingTime = await _workingTimeRepository.GetById(id);
        ...
        public async Task<ActionResult<IList<Domain.Core.WorkManagement.WorkingTime.Entity.WorkingTime>>> GetAllByEnvironmentId(int environmentId)
        {
            try
            {
        ...
        [HttpGet("all")]
        public async Task<ActionResult<IList<Domain.Core.WorkManagement.WorkingTime.Entity.WorkingTime>>> GetAll()
        {
            try
            {
        ...
        [HttpPost]
        public async Task<ActionResult<Domain.Core.WorkManagement.WorkingTime.Entity.WorkingTime>> Insert([FromBody] Domain.Core.WorkManagement.WorkingTime.Entity.WorkingTime workingTime)
        {
            try
            {
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<Domain.Core.WorkManagement.WorkingTime.Entity.WorkingTime>> Update(int id, [FromBody] Domain.Core.WorkManagement.WorkingTime.Entity.WorkingTime workingTime)
        {
            try
            {
