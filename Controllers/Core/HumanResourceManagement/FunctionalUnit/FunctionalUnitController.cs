...
namespace Workforce.Server.Controllers.Core.HumanResourceManagement.FunctionalUnit
{
    ...
    public class FunctionalUnitController : ControllerBase
    {
        ...
        public async Task<ActionResult<Domain.Core.WorkManagement.FunctionalUnit.Entity.FunctionalUnit>> GetByIdAsync(int id, CancellationToken ct)
        {
        ...
        [HttpGet("all")]
        public async Task<ActionResult<IList<Domain.Core.WorkManagement.FunctionalUnit.Entity.FunctionalUnit>>> GetAllAsync(CancellationToken ct)
        {
        ...
        public async Task<ActionResult<IList<Domain.Core.WorkManagement.FunctionalUnit.Entity.FunctionalUnit>>> GetAllByEnvironmentIdAsync(int environmentId, CancellationToken ct)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<Domain.Core.WorkManagement.FunctionalUnit.Entity.FunctionalUnit>> InsertAsync(Domain.Core.WorkManagement.FunctionalUnit.Entity.FunctionalUnit entity, CancellationToken ct)
        {
        ...
        [HttpPut("{id:int}")]
        public async Task<ActionResult<Domain.Core.WorkManagement.FunctionalUnit.Entity.FunctionalUnit>> UpdateAsync(int id, Domain.Core.WorkManagement.FunctionalUnit.Entity.FunctionalUnit entity, CancellationToken ct)
        {
